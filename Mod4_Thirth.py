...
# df = pd.read_excel('Final_Modul4_Genel_sıralama_tablosu.xlsx', engine='openpyxl', sheet_name=None)

# # Create a new Excel writer for the cumulative calculations
# writer = pd.ExcelWriter('Modul4_Cumulative_Statistics1.xlsx', engine='xlsxwriter')
...
# print(f"Cumulative statistics calculation completed. Please check 'Modul4_Cumulative_Statistics.xlsx'.")
