...
output_file = 'Modul5_Genel_sıralama_tablosu.xlsx'
output_df = pd.read_excel(output_file, sheet_name=None)

# Create an Excel writer
writer = pd.ExcelWriter('Final_Modul5_Genel_sıralama_tablosu.xlsx', engine='xlsxwriter')
        ...
        for index, row in weekly_summary.iterrows():
            ...
            if pd.notna(pre_home_rank) and pd.notna(pre_away_rank):  # Ensure ranks are not NaN
                if pre_home_rank < pre_away_rank:
                    ...
                    weekly_summary.at[index, 'Match Play'] = 1
                else:
...
print("Process completed, please check 'Final_Modul5_Genel_sıralama_tablosu.xlsx'.")