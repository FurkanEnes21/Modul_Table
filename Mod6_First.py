...
writer = pd.ExcelWriter('Modul6_Genel_sıralama_tablosu.xlsx', engine='xlsxwriter')
...
print(f"Process completed, please check 'Modul6_Genel_sıralama_tablosu.xlsx'. Number of sheets created: {sheet_count}")
