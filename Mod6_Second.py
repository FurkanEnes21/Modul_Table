...
output_file = 'Modul6_Genel_sıralama_tablosu.xlsx'
output_df = pd.read_excel(output_file, sheet_name=None)

# Create an Excel writer
writer = pd.ExcelWriter('Final_Modul6_Genel_sıralama_tablosu.xlsx', engine='xlsxwriter')
...
print("Process completed, please check 'Final_Modul6_Genel_sıralama_tablosu.xlsx'.")