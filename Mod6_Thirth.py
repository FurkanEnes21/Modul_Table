...
df = pd.read_excel('Final_Modul6_Genel_sıralama_tablosu.xlsx', engine='openpyxl', sheet_name=None)

# Create a new Excel writer for the cumulative calculations
writer = pd.ExcelWriter('Modul6_Cumulative_Statistics.xlsx', engine='xlsxwriter')
...
print(f"Cumulative statistics calculation completed. Please check 'Modul6_Cumulative_Statistics.xlsx'.")
